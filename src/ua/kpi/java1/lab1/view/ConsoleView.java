package ua.kpi.java1.lab1.view;

import org.apache.logging.log4j.Level;
import org.apache.logging.log4j.LogManager;
import org.apache.logging.log4j.Logger;
import ua.kpi.java1.lab1.exceptions.IllegalInputException;
import ua.kpi.java1.lab1.model.Mode;
import ua.kpi.java1.lab1.model.Student;
import ua.kpi.java1.lab1.reader.DataReader;
import ua.kpi.java1.lab1.validator.Validator;
  ...
  public Mode readMode() {
    ...
    try {
      ...
      if (!validator.validate(value)) {
        throw logger.throwing(Level.WARN, new IllegalInputException("Illegal value was entered"));
      }
